      ...
      <main className={styles.main}>
        <div className={styles.logo}>
          ...
          <div className={styles.sign}>
            <div>회원이 아니신가요?</div>
            <a href="/auth/signup">회원 가입하기</a>
          </div>
        </div>

        <form className={styles.form}>
          <AuthInput label="이메일" type="email" placeholder="이메일을 입력해 주세요." />
          <AuthInput label="비밀번호" type="password" placeholder="비밀번호를 입력해 주세요." />
        </form>

        <CtaLong onClick={onLogin}>로그인</CtaLong>
