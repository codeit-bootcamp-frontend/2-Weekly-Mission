...
function FolderListSection() {
	...
	const [nowFolderId, setNowFolderId] = useState(null);
	...
	const onClickFolderBlock = (e: React.MouseEvent<HTMLDivElement>) => {
	...
	return (
		<Container>
			...
			<FoldersBar>
				<FolderBlockWrapper>
					<FolderBlock $isActive={true} onClick={onClickFolderBlock}>
						전체
					</FolderBlock>
					{folderList ? (
