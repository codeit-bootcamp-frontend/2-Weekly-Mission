      ...
      {isLoading ? (
        ...
        <div className="sorting-area">
          <ul className="sorting-tab">
            <li className="list">
              <button
                className={selectedTab === null ? "clicked" : ""}
            ...
            {tabs?.map((tab) => {
              return (
                <li key={tab.id} className="list">
                  <button
                    className={selectedTab === tab.id ? "clicked" : ""}
            ...
            {isError?.message && (
              <span className="error">{isError.message}</span>
            )}
          </ul>
          <button onClick={handleaddClick}>
            <img className="more-btn" src={addImage} alt="더보기" />
          </button>
        </div>
      )}
      {openModal && (
